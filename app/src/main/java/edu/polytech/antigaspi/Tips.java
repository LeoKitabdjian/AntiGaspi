...
public class Tips extends ArrayList<Tip> {
    public Tips(){
        ...
        add(new Tip(saltFactory.buildIngredient("Pomme"), "Si vous mettez une pomme au frigo, elle va noircir mais vous pouvez toujours la manger tant qu'elle n'est pas abimée"));
        add(new Tip(saltFactory.buildIngredient("Banane"), "Vous pouvez manger une banane même si celle-ci a noirci"));
